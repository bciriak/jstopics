...
<CodeBlock language='typescript' fileName='App.tsx' text={`type User = {
  id: string
  username: string
}`} />
...
<CodeBlock language='typescript' fileName='App.tsx' text={`const [users, setUsers] = useState<User[]>([])
...
<CodeBlock language='typescript' fileName='App.tsx' text={`useEffect(() => {
...
<CodeBlock language='typescript' fileName='Form.tsx' text={`type FormData = {
  username: string
  password: string
}`} />
...
<CodeBlock language='typescript' fileName='Form.tsx' text={`const initialState: FormData = {
  username: '',
  password: ''
}`} />
...
<CodeBlock language='typescript' fileName='Form.tsx' text={`const [formData, setFormData] = useState<FormData>(initialState)`} />
...
<CodeBlock language='typescript' fileName='Form.tsx' text={`return (
  <form>
    <div>
...
<CodeBlock language='typescript' fileName='Form.tsx' text={`const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
  e.preventDefault()
