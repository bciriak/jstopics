...
If you don't know **Vite**, have a look at <MdLink url='https://www.jstopics.com/reactjs/vite-create-react-app' text='Create React App With Vite' />.
...
I hope you liked this more _in depth_ article. If you did leave a reaction or a comment down below. Thank you for sticking around and I will see you in the next one.
