...
<CodeBlock language='javascript' fileName='' text={`for (let i = 0; i < 5; i++) {
...
<CodeBlock language='javascript' fileName='app.js' text={`let myArray = []
...
<CodeBlock language='shell' fileName='terminal' text={`node app.js
...
<CodeBlock language='javascript' fileName='app.js' text={`for (let ii = 0; ii < 2; ii += 1) {
...
<CodeBlock language='javascript' fileName='app.js' text={`let myArr = [1,2,3];
