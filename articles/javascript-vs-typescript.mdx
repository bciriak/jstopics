...
<a href="https://www.typescriptlang.org/" target="_blank" alt="TypeScript official website" >TypeScript</a> was created by Microsoft in 2012 and is **strongly typed language build on top of JavaScript**. 
